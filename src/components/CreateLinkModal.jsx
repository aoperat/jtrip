      ...
      <div className="space-y-4 mb-10">
        ...
        {isPrep && (
          <div className="grid grid-cols-2 gap-3">
            <button className="py-4 bg-blue-50 text-blue-600 rounded-2xl font-bold text-xs border border-blue-100 uppercase tracking-widest tracking-tighter leading-none">
              Common
            </button>
            <button className="py-4 bg-slate-50 text-slate-400 rounded-2xl font-bold text-xs border border-slate-100 uppercase tracking-widest tracking-tighter leading-none">
              Personal
            </button>
          </div>
        )}
