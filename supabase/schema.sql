...
-- RLS 정책 예시 (참여자만 접근 가능)
-- 실제 사용 시 더 세밀한 정책이 필요합니다
...
-- Travel_Participants: 참여자만 조회 가능
